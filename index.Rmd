...
Let $k$ be a non-negative integer and $t \in [0,1]$, the Bernstein polynomials of degree $k$ are defined by
...
**Definition:**  The Bernstein polynomials of degree 1 are represented by the following equations:  
