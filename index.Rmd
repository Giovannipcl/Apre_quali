...
** Proposition ** Let $h_j(y)$ be the transformation function defined in (\ref{bern_transf}) with Bernstein basis representation. Let $\boldsymbol{\gamma}_j = \boldsymbol{\Sigma}_j \boldsymbol{\tilde{\beta}}_j$ with $\boldsymbol{\tilde{\beta}}_j = (\beta_{j,1}, \exp(\beta_{j,2}), \dots, \exp(\beta_{j,q}))^\top$.
...
$$\begin{equation}\label{bern_transf}
    h_j(y) = \boldsymbol{a}_j(y)^{\top} \boldsymbol{\gamma}_j
\end{equation}$$
...
$$\begin{equation}\label{mode_condi}
    \boldsymbol{\beta}_{-r}^{*}(\beta_r, \boldsymbol{\tau}) = E_{\Tilde{\pi}_G(\boldsymbol{\beta}_{-r} |\beta_r)} = \boldsymbol{\beta}^{*}(\boldsymbol{\tau})_{-r} + (H_{-r,r})^{-1}H_{r,r}\left[\beta_r -  \boldsymbol{\beta}^{*}(\boldsymbol{\tau})_{r}\right].
\end{equation}$$
...
.tg td{background-color:#fff;border-color:#aaa;border-style:solid;border-width:0px;color:#333;
  font-family:Arial, sans-serif;font-size:4px;overflow:hidden;padding:10px 5px;word-break:normal;}
.tg th{background-color:#fff;border-color:#aaa;border-style:solid;border-width:0px;color:#000;
  font-family:Arial, sans-serif;font-size:8px;font-weight:normal;overflow:hidden;padding:10px 5px;word-break:normal;}
.tg .tg-baqh{text-align:center;vertical-align:top}
.tg .horizontal-line td {
  border-bottom: 2px solid #000; /* Adiciona uma linha horizontal */
}
...
<thead>
  <tr>
    <td class="tg-ao2g" rowspan="2">True Parameter ($\beta$)</td>
    <td class="tg-baqh" colspan="2">n = 200</td>
    <td class="tg-baqh" colspan="2">n = 500</td>
    <td class="tg-baqh" colspan="2">n = 2000</td>
  </tr>
  <tr>
    <td class="tg-0pky">Estimate</td>
...
<font size="3">
<table class="tg">
 <caption>Posterior mean and root-mean-squared-error of the parameters for Model 3: $\Phi(\boldsymbol{a}(y)^T \boldsymbol{\gamma} + \bfs{x}^T \bfs{\beta} + \bfs{z}^T \bfs{b} )$ using ILBCTM algorithm, considering 500 replicas, in the simulating study 1.</caption>
<thead>
  <tr>
    <td class="tg-ao2g" rowspan="2">True Parameter ($\beta$)</td>
    <td class="tg-baqh" colspan="2">n = 10</td>
    <td class="tg-baqh" colspan="2">n = 20</td>
    <td class="tg-baqh" colspan="2">n = 30</td>
  </tr>
  <tr>
    <td class="tg-0pky">Estimate</td>
    <td class="tg-0pky">RMSE</td>
...
<tbody>
  ...
  <td class="tg-0pky">-0.2977</td>
      ...
      <td class="tg-0pky">0.0409</td>
      <td class="tg-0pky">-0.2954</td>
      <td class="tg-0pky">0.0226</td>
      <td class="tg-0pky">-0.2979</td>
      <td class="tg-0pky">0.0240</td>
      </tr>
  <tr>
  <td class="tg-0pky">-0.2970</td><td class="tg-0pky">-0.2984</td><td class="tg-0pky">0.0381</td><td class="tg-0pky">-0.2957</td><td class="tg-0pky">0.0225</td><td class="tg-0pky">-0.2981</td><td class="tg-0pky">0.0241</td></tr>
  <tr><td class="tg-0pky">-0.3015</td><td class="tg-0pky">-0.2912</td><td class="tg-0pky">0.0334</td><td class="tg-0pky">-0.2961</td><td class="tg-0pky">0.0226</td><td class="tg-0pky">-0.2985</td><td class="tg-0pky">0.0232</td></tr>
  <tr><td class="tg-0pky">-0.2987</td><td class="tg-0pky">-0.2919</td><td class="tg-0pky">0.0327</td><td class="tg-0pky">-0.2963</td><td class="tg-0pky">0.0226</td><td class="tg-0pky">-0.2990</td><td class="tg-0pky">0.0232</td></tr>
  <tr><td class="tg-0pky">-0.2948</td><td class="tg-0pky">-0.2955</td><td class="tg-0pky">0.0348</td><td class="tg-0pky">-0.2964</td><td class="tg-0pky">0.0231</td><td class="tg-0pky">-0.2996</td><td class="tg-0pky">0.0237</td></tr>
  <tr><td class="tg-0pky">-0.2964</td><td class="tg-0pky">-0.2910</td><td class="tg-0pky">0.0339</td><td class="tg-0pky">-0.2976</td><td class="tg-0pky">0.0222</td><td class="tg-0pky">-0.3005</td><td class="tg-0pky">0.0231</td></tr>
  <tr><td class="tg-0pky">-0.2980</td><td class="tg-0pky">-0.2940</td><td class="tg-0pky">0.0328</td><td class="tg-0pky">-0.2982</td><td class="tg-0pky">0.0221</td><td class="tg-0pky">-0.3005</td><td class="tg-0pky">0.0226</td></tr>
  <tr><td class="tg-0pky">-0.2961</td><td class="tg-0pky">-0.2935</td><td class="tg-0pky">0.0327</td><td class="tg-0pky">-0.2984</td><td class="tg-0pky">0.0224</td><td class="tg-0pky">-0.2984</td><td class="tg-0pky">0.0227</td></tr>
  <tr><td class="tg-0pky">-0.2954</td><td class="tg-0pky">-0.2932</td><td class="tg-0pky">0.0327</td><td class="tg-0pky">-0.2985</td><td class="tg-0pky">0.0227</td><td class="tg-0pky">-0.2976</td><td class="tg-0pky">0.0232</td></tr>
  <tr><td class="tg-0pky">-1.5000</td><td class="tg-0pky">-1.4679</td><td class="tg-0pky">0.0838</td><td class="tg-0pky">-1.4862</td><td class="tg-0pky">0.0552</td><td class="tg-0pky">-1.4672</td><td class="tg-0pky">0.0590</td></tr>
  <tr><td class="tg-0pky">-0.8000</td><td class="tg-0pky">-0.7706</td><td class="tg-0pky">0.0593</td><td class="tg-0pky">-0.7949</td><td class="tg-0pky">0.0375</td><td class="tg-0pky">-0.7774</td><td class="tg-0pky">0.0370</td></tr>
</tbody>
</table>
</font>
...
.tg td {
  ...
  font-size: 18px !important;  /* Forçando a aplicação do estilo */
  overflow: hidden;
  padding: 10px 5px;
  word-break: normal;
}
...
.caption-style {
  font-size: 18px !important;  /* Forçando a aplicação da legenda */
  text-align: center;
  margin-bottom: 10px;
}

.horizontal-line {
  border-top: 2px solid #000;  /* Linha horizontal */
  text-align: center;
  height: 0;
}
</style>
...
<table class="tg">
  <caption class="caption-style">Estimated average &sigma;<sub>KL</sub>D for BCTM, CTM and Skew Normal models across different sample sizes, basis dimension and parameter settings from model with $p = 4$, considering 100 replicas in simulation study 2 for the fixed regression models</caption>
  <thead>
    <tr>
      <td colspan="7" style="text-align: center;">&sigma; = 1, &lambda; = 2</td>
    </tr>
    <tr>
      <td colspan="7" class="horizontal-line"></td> <!-- Linha horizontal -->
    </tr>
    <tr>
      <td rowspan="3">Model</td>
      <td colspan="3" class="tg-baqh">k = 10</td>
      <td colspan="3" class="tg-baqh">k = 20</td>
    </tr>
    <tr>
      <td colspan="3" class="tg-baqh">n</td>
      <td colspan="3" class="tg-baqh">n</td>
    </tr>
    <tr>
      <td>500</td>
...
$$\begin{equation}
    F_{Y_i|\bfs{X}_i = \bfs{x}_i}(Y_i \leq y_i | \bfs{X}_i = \bfs{x}_i) = \Phi(\boldsymbol{a}(y_i)^{\top}\boldsymbol{\gamma} + \boldsymbol{b}(z_{3i})^{\top} \boldsymbol{\beta}_1+ \boldsymbol{b}(z_{4i})^{\top} \boldsymbol{\beta}_2 + \boldsymbol{b}(z_{3i},z_{4i})^{\top}\boldsymbol{\beta}_3 + \boldsymbol{x}_{4i}^{\top}\boldsymbol{\beta}_4) \nonumber
\end{equation}$$
...
.tg th{background-color:#fff;border-color:#aaa;border-style:solid;border-width:1px;color:#000;
  font-family:Arial, sans-serif;font-size:10px;font-weight:normal;overflow:hidden;padding:10px 5px;word-break:normal;}
.tg .tg-baqh{text-align:center;vertical-align:top}
.tg .tg-ao2g{border-color:#fff;text-align:center;vertical-align:top}
.tg .tg-0pky{border-color:#fff;text-align:center;vertical-align:top}
.caption-style {
  font-size: 14px; /* Diminui o tamanho da legenda */
  text-align: center;
  margin-bottom: 10px; /* Ajusta a margem inferior se necessário */
}
</style>

<table class="tg">
  <caption class="caption-style">Estimated average &overline;KLD for BCTM and Skew Normal models across different sample sizes, basis dimension, and parameter settings, case (b), with p = 4, considering 100 replicas in simulation study for the non-linear regression model.</caption>
    <thead>
    <tr>
      <td colspan="7" style="text-align: center;">&sigma; = 1, &lambda; = 2</td>
    </tr>
    <tr>
      <td rowspan="3">Model</td>
      <td colspan="3" class="tg-baqh">k = 10</td>
      <td colspan="3" class="tg-baqh">k = 15</td>
    </tr>
    <tr>
      <td colspan="3" class="tg-baqh">n</td>
      <td colspan="3" class="tg-baqh">n</td>
...
.tg .tg-0pky{border-color:#fff;text-align:center;vertical-align:top}
.caption-style {
  font-size: 12px; /* Diminui o tamanho da legenda */
  text-align: center;
  margin-bottom: 10px; /* Ajusta a margem inferior se necessário */
}
</style>
...
<table class="tg">
  <caption class="caption-style">Estimated average &overline;KLD for BCTM using low-rank correction and Skew Normal models across different sample sizes, basis dimension, and parameter settings, case (c), with p = 4, considering 100 replicas in simulation study for the non-linear regression model.</caption>
  <thead>
    <tr>
            <td colspan="7" style="text-align: center;">&sigma; = 1, &lambda; = 2</td>
    </tr>
...
---
- In the original application the author proposed four different BCTM to predict and make inferences about cholesterol individuals based on their sex and age.
