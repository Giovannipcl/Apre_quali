...
---
### Conditional Transformation Models
- A ideia de transformacao de variaveis aleatorias já é muito popular na área de modelagem. 
- Another well-known example of a transformation model is the Box-Cox transformation. The Box-Cox transformation is a family of power transformations defined as:
$$
Y(\lambda) = 
\begin{cases}
...
\end{cases}
$$
where $\lambda$ is a parameter that determines the type of transformation.
