...
- The first presentation of BCTMs was given by `r Citet(myBib,"carlan2023bayesian")`, where the author proposed the use of monotonic B-spline bases `r Citet(myBib,"pya2015shape")` to model conditional transformation functions. 
...
```{r, echo=FALSE, out.width = "35%", dpi = 300 , fig.cap=".", fig.retina = 2,fig.align='center'}
knitr::include_graphics("figuras/barplot6_2.png")
```
