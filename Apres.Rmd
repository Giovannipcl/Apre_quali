...
```{r,results='asis', echo=FALSE, message=FALSE, warning = FALSE,  fig.retina=2, fig.align='center',out.width = "30%"}
...
```{r, echo=FALSE, out.width = "60%", dpi = 300 , fig.cap="Coefficients from the VCM random effects model.", fig.retina = 2,fig.align='center'}
knitr::include_graphics("figuras/coefs_vcm_re.png")
```
 
]
.pull-right[
```{r, echo=FALSE, out.width = "60%", dpi = 300 , fig.cap="Coefficients from the Tensor model.", fig.retina = 2,fig.align='center'}
knitr::include_graphics("figuras/coef_tensor.png")
```

```{r, echo=FALSE, out.width = "60%", dpi = 300 , fig.cap="Coefficients from the Tensor random effects model.", fig.retina = 2,fig.align='center'}
